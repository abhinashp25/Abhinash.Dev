...
const projects: Project[] = [
  {
    ...
    description: 'AI-driven career guidance and roadmap generation application.',
    longDescription: 'An intelligent platform providing personalized career roadmaps, resume analysis, and skill gap identification. Built using advanced LLMs to generate structured, actionable, and user-specific career progressions. Designed with a robust backend and modern glassmorphic frontend UI.',
  ...
  },
  {
    ...
    longDescription: 'An intelligent plant disease detection system that analyzes leaf images to identify diseases with high accuracy. Built using Convolutional Neural Networks (CNN) with transfer learning. Helps farmers and agricultural professionals quickly diagnose crop diseases.',
    tech: ['Python', 'TensorFlow', 'CNN', 'OpenCV', 'Streamlit'],
    color: '#94a3b8',
  ...
  },
  {
    ...
    longDescription: 'Vigil is a full-stack web application for real-time safety monitoring and intelligent alerting. Features a React frontend with live dashboards, a Node.js/Express backend, and REST API integration. Monitors safety-critical events and dispatches real-time alerts.',
    tech: ['React', 'Node.js', 'Express', 'MongoDB', 'Socket.io'],
    color: '#e2e8f0',
    github: 'https://github.com/abhinashp25/vigil-web',
    demo: 'https://vigil-safety.vercel.app',
    category: 'Full Stack',
    stats: 'Real-time',
  },
  {
    ...
    longDescription: 'A production-ready real-time chat application built with React and Socket.io. Features instant messaging, user authentication, room management, typing indicators, and a clean modern interface.',
  ...
  {
    title: 'Aakash Weather App',
    description: 'Dynamic and responsive weather forecasting application with sleek UI.',
    longDescription: 'A premium weather application providing real-time forecasting, dynamic background state changes based on weather conditions, and precise geographical weather lookups. Designed with high-end typography and animations.',
    tech: ['JavaScript', 'HTML5', 'CSS3', 'Weather API'],
    color: '#475569',
    github: 'https://github.com/abhinashp25/Weather-App',
    demo: 'https://aakash-weather.vercel.app',
    category: 'Frontend',
    stats: 'Dynamic UI',
  },
];
